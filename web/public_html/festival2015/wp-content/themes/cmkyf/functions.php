...
if (!function_exists('cmkyf_setup')):
    ...
    function cmkyf_setup()
    {
        ...
        register_default_headers(array(
            ...
            /*
            'festival_03' => array(
                'url' => '%s/images/headers/CMKY_2014_SPLASH_PAGE_3.jpg',
                'thumbnail_url' => '%s/images/headers/CMY_NYE_WEB_BANNER_123112_1-240x86.jpg',
                //translators: header image description
                'description' => __('Festival 2014 Three', 'twentyeleven'),
                'action' => 'http://cmky.org/festival2014/festival/'
            ...
            'festival_04' => array(
                'url' => '%s/images/headers/CMKY_2014_SPLASH_PAGE_4.jpg',
                'thumbnail_url' => '%s/images/headers/CMY_NYE_WEB_BANNER_123112_1-240x86.jpg',
                // translators: header image description
                'description' => __('Festival 2014 Four', 'twentyeleven'),
                'action' => 'http://cmky.org/festival2014/festival/'
            ),
            'festival_01' => array(
...
function cmky_register_scripts()
{
    ...
    wp_register_script('masonry', get_template_directory_uri() . '/js/masonry.pkgd.min.js', array('jquery'), "1.0", true);
    wp_register_script('cmkyf-partners', get_template_directory_uri() . '/js/partners.js', array('masonry'), "1.0", true);
