...
var locationValidator = new validator();
    locationValidator.addValidator(new requiredValidator("Please select a Location."));
...
var typeValidator = new validator();
    typeValidator.addValidator(new requiredValidator("Please select a Type."));
    
var startTimeValidator = new validator();
    startTimeValidator.addValidator(new requiredValidator("Please enter a Start Time."));
    startTimeValidator.addValidator(new dateTimeValidator("Start Time must have format mm/dd/yyyy hh:mm."));
    
var endTimeValidator = new validator();
    endTimeValidator.addValidator(new requiredValidator("Please enter an End Time."));
    endTimeValidator.addValidator(new dateTimeValidator("End Time must have format mm/dd/yyyy hh:mm."));
...
function onSubmitEventForm()
{
    ...
    errorString = appendLine(errorString, nameValidator.validate(name));
    errorString = appendLine(errorString, descriptionValidator.validate(description));
    errorString = appendLine(errorString, startTimeValidator.validate(start_time));
    errorString = appendLine(errorString, endTimeValidator.validate(end_time));
