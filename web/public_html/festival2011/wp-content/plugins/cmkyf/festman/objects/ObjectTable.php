...
class ObjectTable extends PersistentObject
{
	...
	public static function getObjectTableById($object_table_id)
	{
		...
		$query_string = "SELECT * from " . $fm_db->getObjectTableTableName() . " WHERE ObjectTable_Id=".queryValue($object_table_id);
	...
	public static function getObjectTableByTableName($object_table_name)
	{
		...
		$query_string = "SELECT * FROM " . $fm_db->getObjectTableTableName() . " WHERE TableName='".queryValue($object_table_name)."'";
		$result = mysql_query($query_string);
	...
	public static function getObjectTableByClassName($object_class_name)
	{
		...
		$query_string = "SELECT * FROM " . $fm_db->getObjectTableTableName() . " WHERE ClassName='".queryValue($object_class_name)."'";
		$result = mysql_query($query_string);
	...
	public static function deleteObjectTable($object_table_id)
	{
		...
		$query_string = "DELETE from " . $fm_db->getObjectTableTableName() . " WHERE ObjectTable_Id=".queryValue($object_table_id);
...
function createOrUpdateObjectTable(ObjectTable $object_table)
{
	...
	$id         = queryValue($object_table->getId());
	$class_name = queryValue($object_table->getClassName());
	$table_name = queryValue($object_table->getTableName());
	$id_name    = queryValue($object_table->getIdName());
