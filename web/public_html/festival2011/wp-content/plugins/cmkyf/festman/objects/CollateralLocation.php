...
class CollateralLocation extends PersistentObject
{
	...
	{
		global $fm_db;
		$query_string = "SELECT * from " . $fm_db->getCollateralLocationTableName() . " WHERE CollateralLocation_Id=".queryValue($collateral_location_id);
	...
	{
		global $fm_db;
		$query_string = "SELECT Url FROM " . $fm_db->getCollateralLocationTableName() . " WHERE CollateralLocation_Id=".queryValue($collateral_id);
		$result = mysql_query($query_string);
		...
		$query_string = "DELETE from " . $fm_db->getCollateralLocationTableName() . " WHERE CollateralLocation_Id=".queryValue($collateral_location_id);
...
function createOrUpdateCollateralLocation(CollateralLocation $collateral_location)
{
	...
	$location = queryValue($collateral->geLocation());
