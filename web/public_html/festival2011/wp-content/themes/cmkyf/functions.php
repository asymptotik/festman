...
if ( function_exists('register_sidebar') ) {
	register_sidebar(array(
		'name' => 'Sidebar 1',
		'id' => 'sidebar-1',
		'before_widget' => '<li><div id="%1$s c2-style" class="widget %2$s c2-style">' .
		...
		'after_widget' =>       '</div>' .
						  ...
						  '</div>' .
						'</li>',
		'before_title' => '<div class="widget-title page-panel-header c-border c-bg corners-top"><table class="panel-content"><tr><td class="post-title"><h2>',
		'after_title' =>  '</h2></td></tr></table></div>'.
							'<div class="widget-body page-panel-body c-border corners-bottom"><div class="widget-entry panel-content">',
	));
	
	register_sidebar(array(
		'name' => 'Sidebar 2',
		'id' => 'sidebar-2',
		'before_widget' => '<li><div id="%1$s" class="widget %2$s c2-style">' .
							'<div class="widget-content">',
		'after_widget' =>       '</div>' .
						  	  '</div>' .
						    '</div>' .
