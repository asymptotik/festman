		...
		<div <?php post_class() ?> id="post-<?php the_ID(); ?>">
			...
			<div class="page-panel-body c-border corners-bottom">
				...
				<div class="page-details">
				    <table>
					    <tr>
							<td class="left"><a href ="<?php echo $current_item->getUrl() ?>" class="page-details-link" target=\"_blank\"><?php echo $current_item->getUrlDisplayText() ?></a></td>
							<td class="right">
								<?php 
