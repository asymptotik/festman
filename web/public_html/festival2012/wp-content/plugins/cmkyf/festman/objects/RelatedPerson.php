...
class RelatedPerson extends AbstractCollateralCollection
{
    ...
    public static function getRelatedPerson($related_person_id)
    {
        ...
        $query_string = "SELECT * from " . $fm_db->getRelatedPersonTableName() . " WHERE RelatedPerson_Id=" . fmQueryValue($related_person_id);
    ...
    public static function deleteRelatedPerson($related_person_id)
    {
        ...
        $query_string = "DELETE from " . $fm_db->getRelatedPersonTableName() . " WHERE RelatedPerson_Id=" . fmQueryValue($related_person_id);
...
function createOrUpdateRelatedPerson(RelatedPerson $related_person)
{
    ...
    $id = fmQueryValue($related_person->getId());
    $name = fmQueryValue($related_person->getName());
    $description = fmQueryValue($related_person->getDescription());
    $url = fmQueryValue($related_person->getUrl());
    $url_text = fmQueryValue($related_person->getUrlText());
    $role = fmQueryValue($related_person->getRole());
    $program_item_id = fmQueryValue($related_person->getProgramItem_Id());
