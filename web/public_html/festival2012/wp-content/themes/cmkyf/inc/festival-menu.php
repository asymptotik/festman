...
<nav id="subaccess" role="navigation">
    ...
    <div class="menu">
        <ul>
            ...
            <li class="<?php echo ($subsection === 'installations' ? 'current_page_item' : 'page_item'); ?>"><a title="Installations" href="<?php echo cmkyf_page_url('festival/installations'); ?>">Installations<div class="subtitle">beautiful art</div></a></li>
            <li class="<?php echo ($subsection === 'films' ? 'current_page_item' : 'page_item'); ?>"><a title="Films" href="<?php echo cmkyf_page_url('festival/films'); ?>">Films<div class="subtitle">the big screen</div></a></li>
