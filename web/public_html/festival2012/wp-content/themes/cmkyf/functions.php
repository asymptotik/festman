...
function cmkyf_setup() {
	...
	register_default_headers( array(
		'festival' => array(
			'url' => '%s/images/headers/festival2012.png',
			'thumbnail_url' => '%s/images/headers/festival2012-thumbnail.png',
			/* translators: header image description */
			'description' => __( 'Festival 2012', 'twentyeleven' )
		),
            	'wheel' => array(
...
function twentyeleven_body_classes( $classes ) {
	...
	if ( function_exists( 'is_multi_author' ) && ! is_multi_author() )
        ...
        if (is_page_template( 'template-home.php' ))
            $classes[] = 'singular';
	else if ( is_singular() && ! is_home() && ! is_page_template( 'showcase.php' ) && ! is_page_template( 'sidebar-page.php' ) && ! is_page_template( 'template-festival.php' ))
		$classes[] = 'singular';
...
function cmky_register_scripts()
{
    ...
    wp_register_script('cmkyf-header', get_template_directory_uri() . '/js/header.js', array('jquery-watermark'), "1.0", true );
    ...
    wp_register_script('cmkyf-home', get_template_directory_uri() . '/js/home.js', array('jquery-spotlight'), "1.0", true );
...
{                 
    ...
    echo '    <input name="fields_email" type="text" id="ltxtMailingList" /><input type="button" onClick="cmkyf_submitToMailingList();" name="subscribe" id="lbtnSubmit" value="ok" />'. "\n";
    echo '  </div>'. "\n";
...
function cmkyf_festival_menu()
{
    require( get_template_directory() . '/inc/festival-menu.php' );
}