...
class EventListingCompact implements IControl
{
    private $event = NULL;
        ...
        <div class="cf-nugget-compact">
            <div class="cf-nugget-hero">
                <?php
                    if ($image_url != "")
                    {
                        echo "<a href=" . '#!/event/' . $current_event->getId() . "><img class=\"cf-nugget-image\" src=\"" . $image_url . "\" /></a>";
                    }
                    ?>
            </div>
            ...
            <div class="cf-nugget-body">
                <div class="cf-nugget-content">
                    <?php echo cmkyf_string_excerpt_with_more( $current_event->getDescription() , 140, 'cf-more', '#!/event/' . $current_event->getId()) ?>
                    <div class="clear"></div>
                </div>
