                    ...
                    <nav id="access" role="navigation">
                        ...
                        <div class="menu">
                            <ul>
                                ...
                                <!-- li class="<?php echo ($section === 'events' ? 'current_page_item' : 'page_item'); ?>"><a title="Events" href="<?php echo cmkyf_page_url('events'); ?>">EVENTS<br><div class="subtitle">what's happening</div></a></li -->
